<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.master" AutoEventWireup="true" CodeFile="GoodsDetails.aspx.cs" Inherits="GoodsDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <div id="container">
        <div>
            <div class="a">
                <div class="c">
                     <asp:Label ID="Label1" runat="server" Text="商品ID：" CssClass="lable"></asp:Label><asp:TextBox ID="t1" runat="server" CssClass="g" ReadOnly="True"></asp:TextBox></div>
                <div class="c">
        ...
        <div class="ee">
            <div class="e">
                ...
                <div class="e">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="提交" cssclass="h" OnClick="Button1_Click" /></div>
